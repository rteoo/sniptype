...
- 6 keys exist **only in dist**: `_private_b_codes`, `sample_trigger_a`, `sample_trigger_e`, `sample_trigger_d`, `sample_trigger_f`, `sample_trigger_g`
- 4 keys exist only in source (stale): `_market_sample_codes`, `sample_trigger_b`, `sample_trigger_c`, `sample_trigger_h`
- 6 keys have **different values**: `_private_tool_codes`, `sample_trigger_i`, `_private_a_codes`, `sample_trigger_j`, `_template_codes`, `_private_c_codes`
