...
The current Windows stable release is `v5.1.0`; current Windows beta source is
`v5.2.0-beta.1`. The macOS ARM64 package is the
`v5.0.4-beta.1` preview pending its packaged desktop validation. Stable tags use
