...
Read when the project AGENTS.md runtime pointer applies. This reference preserves the existing runtime guidance; it is not a fresh platform-verification record.
